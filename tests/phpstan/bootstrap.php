...
$outputLs = shell_exec('ls -lart');
echo "<pre>$outputLs</pre>";

$outputApkAdd = shell_exec('apk add --update bash wget ca-certificates openssl ssh-client git tar');
echo "<pre>$$outputApkAdd = shell_exec('apk add --update bash wget ca-certificates openssl ssh-client git tar');
</pre>";

$outputGitClone = shell_exec('git clone git@gitlab.com:arasari/backend-framework.git');
echo "<pre>$outputGitClone</pre>";

$outputLsBis = shell_exec('ls -lart');
echo "<pre>$outputLsBis</pre>";
